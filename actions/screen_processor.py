...
SYSTEM_PROMPT = (
    "You are NEXUS AI, an advanced personal AI operating system developed by Ayushh. "
    "Analyze images with technical precision and intelligence. "
    "Help Ayushh in a way they can understand — don't be overly complex. "
    "Be concise, smart, and helpful. "
    "Respond in maximum 2 short sentences. Speed is priority. "
    "Address the user as 'Ayushh' or simply respond directly. "
    "Ask if Ayushh needs any further help with their problem."
)
            ...
            async for response in self._session.receive():
                ...
                if sc.turn_complete:
                    if transcript_buf and self._player:
                        ...
                        if full:
                            self._player.write_log(f"NEXUS AI: {full}")
